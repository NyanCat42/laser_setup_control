def set_profile_8MDS_70(lib, id):
    ...
    class FeedbackFlags_:
        ...
        FEEDBACK_ENC_FILTER_STRONG = 48
        FEEDBACK_ENC_FILTER_BITS = 48
        FEEDBACK_ENC_FILTER_MEDIUM = 32
        FEEDBACK_ENC_FILTER_WEAK = 16
        FEEDBACK_ENC_ADAPTIVE_HOLDING = 2
        FEEDBACK_ENC_REVERSE = 1
        FEEDBACK_ENC_FILTER_NONE = 0
        FEEDBACK_ENC_TYPE_AUTO = 0
    feedback_settings.FeedbackFlags = FeedbackFlags_.FEEDBACK_ENC_TYPE_SINGLE_ENDED | FeedbackFlags_.FEEDBACK_ENC_FILTER_NONE | FeedbackFlags_.FEEDBACK_ENC_TYPE_AUTO
